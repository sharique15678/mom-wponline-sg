...
{ 
  ...
  this.hreference="javascript:clickOnNode(\""+this.getID()+"\")";
  if(this.getID()==1) {
  	  //alert("Yes!");
          this.hreference="/ESVCLoginController?action=WPOLLogoutUser";
        }
  if (this.hreference) 
  {  //alert("ref is :"+this.hreference);
	if (USEFRAMES)
	  docW = docW + "<a href='" + this.hreference + "' TARGET=\"appFrame\" "
	    //docW = docW + "<a href='" + "javascript:clickOnNode(\""+this.getID()+"\")'" + "' TARGET=\"appFrame\" "
	else
    ...
    if (browserVersion > 0&&this.getID()!=1) 
...
function leftSideHTML(leftSideCoded) {
	...
	//alert("leftSideHTML:return:"+retStr);
	return retStr
}
...
{ //alert("clickOnNode!!!");
  ...
  clickOnNodeObj(fOb);
  //alert ("end of clickOnNode!!!");
}

function clickOnNodeObj(folderObj) 
{ //alert("clickOnNodeObj!!!");
  var state = 0 
  var currentOpen
...
function clickOnLink(clickedId, target, windowName) {
	//alert("clickOnLink!!!!");
	//SR13883 added
	if(parent.parent.portalFrame!=null)
	{
	parent.parent.portalFrame.callSession();
	}
	//Sr13883 end
...
function highlightObjLink(nodeObj) {
  ...
  if (browserVersion == 1 || browserVersion == 3) {
    //alert("insde highlightObjLink!!!");	
    var clickedDOMObj = getElById('itemTextLink'+nodeObj.id);
   
    if (clickedDOMObj != null) {
        if (lastClicked != null) {
            var prevClickedDOMObj = getElById('itemTextLink'+lastClicked.id);
            //alert("last clicked Id:"+lastClicked.id);
...
function getElById(idVal) {
  //alert("getElById!!"+idVal);
  if (document.getElementById != null){
     //alert("getElById!!"+idVal+	";"+document.getElementById(idVal));
  ...
  if(stateInCookie!=null)
  {
    ...
    for (fldPos=0; fldPos<fldArr.length; fldPos++)
    {
      ...
      if (fldStr != "") {
        ...
        if (nodeObj!=null) //may have deleted
          if (nodeObj.setState) {
...
{ 
  ...
  switch(navigator.family)
  {
    ...
    case 'safari':
      ...
      break;
	//SR-MOM-2013-29314 START angelaang
	case 'chrome':
      browserVersion = 1
      break; 
	case 'nn5':
	  browserVersion = 1
	  break;
	//SR-MOM-2013-29314 END angelaang
	default:
  ...
  supportsDeferral = ((navigator.family=='ie4' && navigator.version >= 5 && navigator.OS != "mac") || browserVersion == 3 || navigator.appVersion.indexOf("rv:11.0")>0 );
