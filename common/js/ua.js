...
function detectBrowser()
{
	...
	{
		navigator.org		= 'chrome';
		navigator.version	= parseFloat('0' + ua.substr(i+7), 2);
		navigator.family = 'chrome';
	}else if ((i = ua.indexOf('safari')) != -1)
	{
		navigator.org		= 'safari';
		navigator.version	= parseFloat('0' + ua.substr(i+7), 3);
	...
	navigator.DOMCSS1	= ( (navigator.family == 'gecko') || (navigator.family == 'ie4') ||  (navigator.family == 'chrome') ||  (navigator.family == 'safari'));
	//SR-MOM-2013-29314 END angelaang
